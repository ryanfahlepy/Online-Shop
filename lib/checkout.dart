...
class CheckOut extends StatefulWidget {
  CheckOut({Key, key, required this.description, required this.price})
      : super(key: key);
...
class _CheckOutState extends State<CheckOut> {
  ...
  Future upDeal() async {
    return await users_payment
        .doc(FirebaseAuth.instance.currentUser!.uid)
        .update({'link': imageUrl.toString()})
  ...
  Future updatePp() async {
    firebase_storage.Reference ref = firebase_storage.FirebaseStorage.instance
        .ref('pay # ' + FirebaseAuth.instance.currentUser!.email.toString());
  ...
  CollectionReference users_payment =
      FirebaseFirestore.instance.collection('users-payment');
